...
namespace C5.Tests.trees.RBDictionary
{
    ...
    public class SCGIDictionary
    {
        ...
        {
            Assert.IsTrue(new KeyValuePair<string, string>("Foo", "Bar").Equals(new SCG.KeyValuePair<string, string>("Foo", "Bar")));
            Assert.IsFalse(new KeyValuePair<string, string>("Foo", "Bar").Equals(new SCG.KeyValuePair<string, string>("Foo", "Tree")));
            Assert.IsFalse(new KeyValuePair<string, string>("Foo", "Bar").Equals(new SCG.KeyValuePair<string, string>("Tree", "Bar")));

            Assert.IsTrue(new KeyValuePair<string, string>("Foo", "Bar").Equals((object)new SCG.KeyValuePair<string, string>("Foo", "Bar")));
            Assert.IsFalse(new KeyValuePair<string, string>("Foo", "Bar").Equals((object)new SCG.KeyValuePair<string, string>("Foo", "Tree")));
            Assert.IsFalse(new KeyValuePair<string, string>("Foo", "Bar").Equals((object)new SCG.KeyValuePair<string, string>("Tree", "Bar")));
        }
        ...
        public void Contains()
        {
            Assert.IsTrue(((SCG.ICollection<SCG.KeyValuePair<string, string>>)dict).Contains(new SCG.KeyValuePair<string, string>("C", "2")));
            Assert.IsFalse(((SCG.ICollection<SCG.KeyValuePair<string, string>>)dict).Contains(new SCG.KeyValuePair<string, string>("D", "2")));
            Assert.IsFalse(((SCG.ICollection<SCG.KeyValuePair<string, string>>)dict).Contains(new SCG.KeyValuePair<string, string>("C", "6")));
        }
